        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Questionnaires_AspNetUsers_ProfessorId",
                        column: x => x.ProfessorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DegreeQuestion_Answer = table.Column<short>(type: "smallint", nullable: true),
                    Answer = table.Column<short>(type: "smallint", nullable: true),
                    RangeQuestion_Answer = table.Column<short>(type: "smallint", nullable: true),
                    TextQuestion_Answer = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questionnaires_ProfessorId",
                table: "Questionnaires",
                column: "ProfessorId");
